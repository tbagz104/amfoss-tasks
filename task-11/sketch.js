...
var customerName = prompt("Player1 Enter your name", "");
...
var customer1Name = prompt("Player2 Enter your name", "");
if (customer1Name!= null) {
    alert("Welcome "+ customer1Name)
}
...
function draw() {
  ...
  /* draw scoreboard */
  text(customerName + ":"  + player1Score + "  |  " + customer1Name  + ":"+ player2Score, width / 2, 50);
